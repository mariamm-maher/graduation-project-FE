...
const CampaignPlanner = () => {
  return (
    <section id="campaign-planner" className="py-24 bg-dark-1 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold text-white drop-shadow-[0_2px_20px_rgba(255,107,53,0.4)]">
              AI Campaigns in <span className="text-transparent bg-clip-text bg-gradient-orange">Seconds</span>
            </h2>
              ...
              {plannerFeatures.map((feature, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex gap-4 p-5 rounded-xl glass-effect backdrop-blur-sm hover:bg-primary/5 transition-all duration-300 group"
                  >
                    <motion.div
                      className="flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-orange flex items-center justify-center shadow-lg"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-8 py-4 rounded-xl bg-gradient-orange text-white font-semibold shadow-[0_4px_16px_rgba(255,107,53,0.5)] hover:shadow-[0_8px_28px_rgba(255,107,53,0.7)] transition-all duration-300 flex items-center gap-2"
            >
...
const PlannerGraphic = () => {
  return (
    <div className="relative">
      <motion.svg
        viewBox="0 0 400 500"
        className="w-full h-auto max-w-md mx-auto text-primary drop-shadow-[0_0_30px_rgba(255,107,53,0.3)]"
        animate={{ y: [0, -15, 0] }}
